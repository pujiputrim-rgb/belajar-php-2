...
if (isset($_POST['save'])) {
  ...
  if ($image['error'] == 0) {
    ...
    if ($id) {
      ...
      // query update
      $update = mysqli_query($conn, "UPDATE sliders SET title='$title', 
      subtitle='$subtitle', description='$description', button1_text='$button1_text',
      button1_link='$button1_link', button2_text='$button2_text',
      image='$filename', button2_link='$button2_link', is_active='$is_active' WHERE id='$id'");
      header("location:sliders.php?update-berhasil");
    } else {
      $insert = mysqli_query($conn, "INSERT INTO sliders (title, subtitle, description, 
      button1_text, button1_link, button2_text, image, button2_link, is_active) 
      VALUES ('$title','$subtitle','$description','$button1_text','$button1_link', 
      '$button2_text','$filename','$button2_link','$is_active')");
      ...
      subtitle='$subtitle', description='$description', button1_text='$button1_text',
      button1_link='$button1_link', button2_text='$button2_text',
      button2_link='$button2_link', is_active='$is_active' WHERE id='$id'");
      header("location:sliders.php?update-berhasil");
    }
  }
                ...
                <div class="card-body">
                  <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text"
                        class="form-control" name="button1_text"
                        placeholder="Enter button 1 text" required value="<?php echo ($id) ? $row['button1_text'] : '' ?>">
                    </div>
                    <div class="mb-3">
                      <label for="" class="form-label fw-bold">Button 1 Link</label>
                      <input type="text"
                        class="form-control" name="button1_link"
                        placeholder="Enter button 1 link" required value="<?php echo ($id) ? $row['button1_link'] : '' ?>">
                    </div>
                    <div class="mb-3">
                      <label for="" class="form-label fw-bold">Button 2 Text</label>
                      <input type="text"
                        class="form-control" name="button2_text"
                        placeholder="Enter button 2 text" required value="<?php echo ($id) ? $row['button2_text'] : '' ?>">
                    </div>
                    <div class="mb-3">
                      <label for="" class="form-label fw-bold">Button 2 Link</label>
                      <input type="text"
                        class="form-control" name="button2_link"
                        placeholder="Enter button 2 link" required value="<?php echo ($id) ? $row['button2_link'] : '' ?>">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                      ...
                      <textarea class="form-control" name="description"
                        cols="30" rows="3"><?php echo ($id) ? $row['description'] : '' ?></textarea>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="is_active" id="radioDefault1"
                        value="1" checked <?php echo ($id) && $row['is_active'] == 1 ? "checked" : '' ?>>
                    ...
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="is_active" id="radioDefault2"
                        value="0" <?php echo ($id) && $row['is_active'] == 0 ? "checked" : '' ?>>
